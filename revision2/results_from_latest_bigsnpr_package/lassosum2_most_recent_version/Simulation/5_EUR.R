...
race1 <- "EUR"
best <- readRDS(paste0("../../",race1,"/rep_",rep,"/lassosum2/prs/results/rho_",rho,"_size_",ifelse(race1=='EUR',4,size),"/",race1,"_best_param.rds"))
...
saveRDS(res, paste0("./lassosum2/prs/results/rho_",rho,"_size_",size,"/", race,"_validation_R2_EUR_best.rds"))
res
