...
dir.create(paste0("./ldpred2/prs/results/rho_",rho,"_size_",size), recursive=T)
...
load(paste0("./ldpred2/prs/tuning/rho_",rho,"_size_",size,"/",race,"-",race,"_tuning_score.RData"))
...
best <- which.max(R2)
saveRDS(best, paste0("./ldpred2/prs/results/rho_",rho,"_size_",size,"/",race,"_best_param.rds"))
...
load(paste0("./ldpred2/prs/validation/rho_",rho,"_size_",size,"/",race,"-",race,"_validation_score.RData"))
...
saveRDS(res, paste0("./ldpred2/prs/results/rho_",rho,"_size_",size,"/",race,"_validation_R2_best.rds"))
res
