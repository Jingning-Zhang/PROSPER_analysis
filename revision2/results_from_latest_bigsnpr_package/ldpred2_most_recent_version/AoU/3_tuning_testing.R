...
load(paste0("./ldpred2/prs/tuning/",race,"_tuning_score.RData"))
...
best <- which.max(R2)
saveRDS(best, paste0("./ldpred2/prs/tuning/",race,"_best.rds"))
...
load(paste0("./ldpred2/prs/validation/",race,"_validation_score.RData"))
...
saveRDS(res, paste0("./ldpred2/prs/results/",race,"_validation_R2_best.rds"))
res
...
saveRDS(res, paste0("./ldpred2/prs/results/",race,"_validation_R2_sl.rds"))

res_sl <- list(lasso=sl1, sl=sl2)
saveRDS(res_sl, paste0("./ldpred2/prs/results/",race,"_sl_models.rds"))
