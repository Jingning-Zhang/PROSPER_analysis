...
sumstats = sumraw[,c("CHR","rsID","POS_b38","A2","A1","BETA","SE","P","N","A1_FREQ_allofus")]
...
dir.create(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision2/update_bigsnpr_results/AoU/",trait), recursive=T)
