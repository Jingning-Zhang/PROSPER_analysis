...
## 2.2.2 ldpred2
tmp <- read_tsv("/Users/jnz_1/Document/JHU/Research/PRS/MEPRS/Analysis/AoU/clean_results/AoU_ldpred2_rev2.txt")
tmp <- reshape2::melt(tmp[,1:5])
colnames(tmp) <- c("t_vec","eth.vec","method_vec","r2.vec")
tmp$method_vec <- as.character(tmp$method_vec)
...
a <- a[a$eth.vec != "EUR",]
write_csv(a, paste0("/Users/jnz_1/Document/JHU/Research/PRS/MEPRS/Manuscript/source_data/revision2/cleaned_tab/AoU.csv"))
