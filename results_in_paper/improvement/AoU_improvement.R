## AoU
library(readr)
dat <- read_csv(paste0("/Users/jnz_1/Document/JHU/Research/PRS/MEPRS/Manuscript/source_data/AoU.csv"))
...
# weighted lassosum2            CT-SLEB            PRS-CSx   weighted LDpred2      EUR lassosum2 
# 0.5680173          0.7653043          0.9128994          1.3144331          5.9655218 
# EUR LDpred2        weighted CT          lassosum2             EUR CT                 CT 
# 6.6942493          7.4683932          9.7454756         15.3454797         17.6311570 
# LDpred2 
# 24.7495847 
...
write_csv(tab, "/Users/jnz_1/Document/JHU/Research/PRS/MEPRS/Manuscript/source_data/AoU_improvement.csv")
