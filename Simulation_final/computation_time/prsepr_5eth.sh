...
mkdir /dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/5pop/

mkdir /dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/5pop/$SGE_TASK_ID
...
--PATH_out /dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/5pop/$SGE_TASK_ID/lassosum2 \
...
Rscript PRS-epr.R \
--PATH_package /dcs04/nilanjan/data/jzhang2/MEPRS/pacakge/PRS-epr \
--PATH_out /dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/5pop/$SGE_TASK_ID/PRSepr \
--FILE_sst /dcs04/nilanjan/data/jzhang2/MEPRS/pacakge/example/summdata/EUR.txt,/dcs04/nilanjan/data/jzhang2/MEPRS/pacakge/example/summdata/AFR.txt,/dcs04/nilanjan/data/jzhang2/MEPRS/pacakge/example/summdata/AMR.txt,/dcs04/nilanjan/data/jzhang2/MEPRS/pacakge/example/summdata/EAS.txt,/dcs04/nilanjan/data/jzhang2/MEPRS/pacakge/example/summdata/SAS.txt \
--pop EUR,AFR,AMR,EAS,SAS \
--chrom 22 \
--lassosum_param /dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/5pop/$SGE_TASK_ID/lassosum2/EUR/optimal_param.txt,/dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/5pop/$SGE_TASK_ID/lassosum2/AFR/optimal_param.txt,/dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/5pop/$SGE_TASK_ID/lassosum2/AMR/optimal_param.txt,/dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/5pop/$SGE_TASK_ID/lassosum2/EAS/optimal_param.txt,/dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/5pop/$SGE_TASK_ID/lassosum2/SAS/optimal_param.txt \
--NCORES 1
