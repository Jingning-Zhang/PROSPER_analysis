...
mkdir /dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/2pop/

mkdir /dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/2pop/$SGE_TASK_ID
...
--PATH_out /dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/2pop/$SGE_TASK_ID/lassosum2 \
...
Rscript PRS-epr.R \
--PATH_package /dcs04/nilanjan/data/jzhang2/MEPRS/pacakge/PRS-epr \
--PATH_out /dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/2pop/$SGE_TASK_ID/PRSepr \
--FILE_sst /dcs04/nilanjan/data/jzhang2/MEPRS/pacakge/example/summdata/EUR.txt,/dcs04/nilanjan/data/jzhang2/MEPRS/pacakge/example/summdata/AFR.txt \
--pop EUR,AFR \
--chrom 22 \
--lassosum_param /dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/2pop/$SGE_TASK_ID/lassosum2/EUR/optimal_param.txt,/dcs04/nilanjan/data/jzhang2/MEPRS/computation_time/prsepr/2pop/$SGE_TASK_ID/lassosum2/AFR/optimal_param.txt \
--NCORES 1
