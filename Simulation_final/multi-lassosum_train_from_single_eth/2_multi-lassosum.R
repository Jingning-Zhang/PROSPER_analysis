...
save(ethnic, M, delta_best, runtime, res,
     file= paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/Simulation_final/multi-lassosum_train_from_single_eth/Setting_",setting,"/",ethnic1,"/rep_",rep,"/2_multi-lassosum_by_chr_",para,"/tuning/rho_",rho,"_size_",size,"_chr",chr,".RData"))
