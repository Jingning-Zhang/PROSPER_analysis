...
cd /dcs04/nilanjan/data/jzhang2/MEPRS/codes/Simulation_final/multi-lassosum_train_from_single_eth/Setting_${setting}/${ethnic1}/9_multi-lassosum_validation_${para}
...
qsub -l h=${skipnode} -hold_jid seven_cs-${M}ethnicity-${ethnic1}-GA_${setting}_rep_${rep}_sub_fixEUR rep_${rep}_fixEUR.sh
