...
dir.create(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/codes/real_data_analysis/GLGC/multi-lassosum_train_from_single_eth/",ethnic1,"/9_0_ukbb_match_score_",para,""))
...
writeLines(a,  paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/codes/real_data_analysis/GLGC/multi-lassosum_train_from_single_eth/",ethnic1,"/9_0_ukbb_match_score_",para,"/ind_Rout.txt"))
writeLines(b,  paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/codes/real_data_analysis/GLGC/multi-lassosum_train_from_single_eth/",ethnic1,"/9_0_ukbb_match_score_",para,"/ind_para.txt"))
...
writeLines(a, paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/codes/real_data_analysis/GLGC/multi-lassosum_train_from_single_eth/",ethnic1,"/9_0_ukbb_match_score_",para,"/ALL.sh"))
paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/codes/real_data_analysis/GLGC/multi-lassosum_train_from_single_eth/",ethnic1,"/9_0_ukbb_match_score_",para,"/ALL.sh")
