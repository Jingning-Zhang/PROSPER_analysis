...
for (ethnic in c("AFR","AMR","EAS","SAS")){
  for (method in  c("lassosum2",
    ...
    for (trait in c("HDL","LDL","logTG","nonHDL","TC")){
        ...
        if(method == "lassosum2"){
          tryCatch({R2 <- readRDS(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/GLGC/lassosum2/Results/final_results/",ethnic,"_",trait,"_validation_R2_best.rds")) }, error=function(e){})
          ...
          tryCatch({R2 <- readRDS(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/GLGC/lassosum2/Results/final_results/",ethnic,"_",trait,"_validation_R2_best_EUR_lassosum2.rds")) }, error=function(e){})
          ...
          tryCatch({R2 <- readRDS(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/GLGC/weighted_lassosum2/final_results/",ethnic,"_",trait,"_validation_R2_weighted.rds")) }, error=function(e){})
