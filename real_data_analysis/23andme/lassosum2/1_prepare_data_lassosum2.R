...
tmp <- tryCatch({ rds <- snp_readBed(paste0("/dcs04/nilanjan/data/23andme/Analysis/JZ/ref_geno/",ethnic,"/",trait,"/allchr.bed")) }, error=function(e) e, warning=function(w) w)
if(is(tmp,"error")){ rds <- paste0("/dcs04/nilanjan/data/23andme/Analysis/JZ/ref_geno/",ethnic,"/",trait,"/allchr.rds") }
...
saveRDS(df_beta, file = paste0("/dcs04/nilanjan/data/23andme/Analysis/JZ/lassosum2/Results/",ethnic,"_",trait,"_df_beta.rds"))
