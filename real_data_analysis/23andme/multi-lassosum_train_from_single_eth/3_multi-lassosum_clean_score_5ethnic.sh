...
cd /dcs04/nilanjan/data/jzhang2/MEPRS/codes/real_data_analysis/23andme/multi-lassosum_train_from_single_eth/${ethnic1}/3_multi-lassosum_by_chr_${para}_clean_score
...
qsub -l h=${skipnode} -hold_jid "meprs-${M}ethnicity-${ethnic1}_from_single" ALL.sh
#
#qsub -hold_jid "meprs-${M}ethnicity-${ethnic1}" -t 13-16 ALL.sh
#qsub -t 16-20 ALL.sh
#
