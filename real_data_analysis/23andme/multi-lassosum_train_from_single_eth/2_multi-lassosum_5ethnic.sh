...
cd /dcs04/nilanjan/data/jzhang2/MEPRS/codes/real_data_analysis/23andme/multi-lassosum_train_from_single_eth/${ethnic1}/2_multi-lassosum_by_chr_${para}
...
#qsub -l h=${skipnode} -t 67-88 ALL.sh
