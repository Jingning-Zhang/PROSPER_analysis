...
sumstats <- sumdata[,c(2,1,3,9,8,5,6,7,4)]
...
ref <- fread2(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/allofus/ref_geno/",ethnic,"/",trait,"/allchr.bim"))
...
tmp <- tryCatch({ rds <- snp_readBed(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/allofus/ref_geno/",ethnic,"/",trait,"/allchr.bed")) }, error=function(e) e, warning=function(w) w)
if(is(tmp,"error")){ rds <- paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/allofus/ref_geno/",ethnic,"/",trait,"/allchr.rds") }
...
dir.create(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/allofus/"))
dir.create(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/allofus/lassosum2/"))
dir.create(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/allofus/lassosum2/intermediate"))
dir.create(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/allofus/lassosum2/intermediate/",ethnic))
dir.create(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/allofus/lassosum2/intermediate/",ethnic,"/",trait))
workdir <- paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/allofus/lassosum2/intermediate/",ethnic,"/",trait)
df_beta <- info_snp
...
save(df_beta, corr, file = paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/allofus/lassosum2/Results/",ethnic,"_",trait,"_corr.RData"))
saveRDS(df_beta, file = paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/allofus/lassosum2/Results/",ethnic,"_",trait,"_df_beta.rds"))
