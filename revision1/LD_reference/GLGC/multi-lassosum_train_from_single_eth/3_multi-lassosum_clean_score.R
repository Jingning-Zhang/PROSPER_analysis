...
df_beta <- readRDS(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/lassosum2/Results/",targetethnic,"_",trait,"_df_beta.rds"))
...
for (chr in 1:22){
  ...
  load(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/multi-lassosum_train_from_single_eth/",ethnic1,"/2_multi-lassosum_by_chr_",para,"/tuning/",trait,"_chr",chr,".RData"))
  delta <- delta_best
  #indx, indx_block, M, snp_list, ethnic,
  load(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/multi-lassosum/",ethnic1,"/1_standard_data/",trait,"/chr",chr,".RData"))
  ...
  if(chr==1){
    ...
    bim.ref <- fread2(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/ref_geno/",targetethnic,"/",trait,"/ref_chr", chr,".bim"))
...
fwrite2(df, paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/multi-lassosum_train_from_single_eth/",ethnic1,"/2_multi-lassosum_by_chr_",para,"/Results/beta_",targetethnic,"_",trait,".txt"), col.names = F, sep="\t", nThread=NCORES)
write_tsv(as.data.frame(param), paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/multi-lassosum_train_from_single_eth/",ethnic1,"/2_multi-lassosum_by_chr_",para,"/Results/para_",trait,".txt"))
