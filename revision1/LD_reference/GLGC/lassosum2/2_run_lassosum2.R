...
load(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/lassosum2/Results/",ethnic,"_",trait,"_corr.RData"))
...
save(df_beta, beta_lassosum2, params2, file = paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/lassosum2/Results/",ethnic,"_",trait,".RData"))
