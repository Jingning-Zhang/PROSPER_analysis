...
load(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/lassosum2/Results/",ethnic,"_",trait,".RData"))
...
fwrite2(df, paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/lassosum2/Results/beta_",ethnic,"_",trait,".txt"), col.names = F, sep="\t", nThread=NCORES)
write_tsv(params2, paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/lassosum2/Results/para_",ethnic,"_",trait,".txt"))
