...
for (l in 1:M){
  load(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/multi-lassosum/",ethnic[l],"/",trait,"/standard_data/chr",chr,"_LD.RData"))
  Nsnps0[[l]] <- Nsnps
...
N0 <- numeric(length = M)
for (l in 1:M){
  df_beta <- readRDS(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/real_data_analysis/GLGC/lassosum2/Results/",ethnic[l],"_",trait,"_df_beta.rds"))
...
for (l in 1:M){
  para <- read_tsv(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/lassosum2/Results/para_",ethnic[l],"_",trait,".txt"))
  best <- readRDS(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/lassosum2/Results/final_results/",ethnic[l],"_",trait,"_best.rds"))
...
saveRDS(summ_list,paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/multi-lassosum/",ethnic1,"/1_standard_data/",trait,"/summ_list_chr",chr,".rds"))
saveRDS(snps_scale,paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/multi-lassosum/",ethnic1,"/1_standard_data/",trait,"/snps_scale_chr",chr,".rds"))
saveRDS(LD_list,paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/multi-lassosum/",ethnic1,"/1_standard_data/",trait,"/LD_list_chr",chr,".rds"))

save(indx, indx_block, delta_best, lambda_best, summ_max, M, snp_list, Nsnps, ethnic, N,
     file=paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/LD_reference/GLGC/multi-lassosum/",ethnic1,"/1_standard_data/",trait,"/chr",chr,".RData"))
