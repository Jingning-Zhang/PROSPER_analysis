...
for (chr in 1:22){
  ...
  load(paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/para_c/GLGC/multi-lassosum_train_from_single_eth/",ethnic1,"/2_multi-lassosum_by_chr_",para,"/tuning/",trait,"_chr",chr,".RData"))
  delta <- delta_best
...
fwrite2(df, paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/para_c/GLGC/multi-lassosum_train_from_single_eth/",ethnic1,"/2_multi-lassosum_by_chr_",para,"/Results/beta_",targetethnic,"_",trait,".txt"), col.names = F, sep="\t", nThread=NCORES)
write_tsv(as.data.frame(param), paste0("/dcs04/nilanjan/data/jzhang2/MEPRS/revision1/para_c/GLGC/multi-lassosum_train_from_single_eth/",ethnic1,"/2_multi-lassosum_by_chr_",para,"/Results/para_",trait,".txt"))
