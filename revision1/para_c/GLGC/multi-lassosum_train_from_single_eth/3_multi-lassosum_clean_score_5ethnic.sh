...
cd /dcs04/nilanjan/data/jzhang2/MEPRS/codes/revision1/para_c/GLGC/multi-lassosum_train_from_single_eth/${ethnic1}/3_multi-lassosum_by_chr_${para}_clean_score
